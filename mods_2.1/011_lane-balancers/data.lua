...
if mods["space-age"] then
  ...
  if mods["AdvancedBeltsSA"] then
    ...
    for technology_name, recipe_name in pairs({
      ["extreme-logistics"] = "extreme-lanesplitter",
      ["ultimate-logistics"] = "ultimate-lanesplitter",
      ["high-speed-logistics"] = "high-speed-lanesplitter",
    }) do
      for i, effect in ipairs(data.raw["technology"][technology_name].effects) do
    ...
    -- if helpers.compare_versions(mods["AdvancedBeltsSA"], "2.3.2") ~= -1 then
    --   data.raw["item"]["extreme-lanesplitter"].hidden = true
    --   data.raw["lane-splitter"]["extreme-lanesplitter"].next_upgrade = nil
    --   data.raw["item"]["ultimate-lanesplitter"].hidden = true
    --   data.raw["lane-splitter"]["ultimate-lanesplitter"].next_upgrade = nil
    --   data.raw["item"]["high-speed-lanesplitter"].hidden = true
    -- end
  end
end
