...
local furnace = {
  ...
  {{
    ...
    pipe_connections =
    {
      ...
      { direction = defines.direction.north, position = {0, 0}, enable_working_visualisations = { "pipe-connection", "pipe-covers" }, hide_connection_info = true},
      { direction = defines.direction.east , position = {0, 0}, enable_working_visualisations = { "pipe-connection", "pipe-covers" }, hide_connection_info = true},
      { direction = defines.direction.south, position = {0, 0}, enable_working_visualisations = { "pipe-connection", "pipe-covers" }, hide_connection_info = true},
      { direction = defines.direction.west , position = {0, 0}, enable_working_visualisations = { "pipe-connection", "pipe-covers" }, hide_connection_info = true},
    },
  ...
  if mods["the-one-mod-with-underground-bits"] then -- actual-underground-pipes
