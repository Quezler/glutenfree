...
local function on_post_gui_opened(event)
  ...
  for _, row in pairs(scroll_pane.children) do
    local tags = row.tags
    if not global.player_index_to_selected_zones_map[event.player_index]
    or not global.player_index_to_selected_zones_map[event.player_index][tags.zone_type]
    or not global.player_index_to_selected_zones_map[event.player_index][tags.zone_type][tags.zone_index] then
...
local function mark_as_seen(player_index, tags)
  ...
  global.player_index_to_selected_zones_map[player_index][tags.zone_type]                  = global.player_index_to_selected_zones_map[player_index][tags.zone_type] or {}
  global.player_index_to_selected_zones_map[player_index][tags.zone_type][tags.zone_index] = true
end
