...
assert(data.raw.item["kr-steel-pipe"] and data.raw.technology["kr-steel-fluid-handling"] and data.raw.tool["kr-basic-tech-card"], "You do not seem to have a Krastorio 2 fork installed/enabled.")

require("namespace")

local config = {
  name = "elevated-steel-pipe",
...
data:extend{
  ...
  },
  {
    ...
    prerequisites = {"elevated-pipe", "kr-steel-fluid-handling"},
    unit =
    {
      count = 100,
      ingredients = {
