...
function get_track_below_player(player)
  return player.surface.find_entity("straight-rail", player.position) or player.surface.find_entity("curved-rail-a", player.position) or player.surface.find_entity("curved-rail-b", player.position)
end
